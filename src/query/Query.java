...
//        map.addMapMarker(new MapMarkerSimple(layer,util.Util.statusCoordinate((Status) arg)));
          String name = ((Status) arg).getUser().getName();
          String url = ((Status) arg).getUser().getProfileImageURL();
          map.addMapMarker(new MapMarkerComplex
                          (layer,
                                  name,
                  util.Util.statusCoordinate((Status) arg),color, ((Status) arg).getText(), url));
      }
    }
}
