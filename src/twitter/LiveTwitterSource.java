...
public class LiveTwitterSource extends TwitterSource {
    ...
    private void initializeTwitterStream() {
        ...
        cb.setOAuthConsumerKey("rp98218VSVRwVYGeHFeEXwNQw")
                .setOAuthConsumerSecret("ES5hkNwtUnkKD6TeUVHHH7QhUPgzTnTjaaXxWMf2v4l3BApSZI")
                .setOAuthAccessToken("858850708975702017-q1Bea0gcdjrTKCNEBnfYOa2nJYqrWMQ")
                .setOAuthAccessTokenSecret("viyYMRtprAZq3JNYzlaMkLznvuEIDsiPhQkabBZ2wlqyg");
