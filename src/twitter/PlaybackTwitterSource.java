...
public class PlaybackTwitterSource extends TwitterSource {
    ...
    private ObjectSource source = new ObjectSource("D:\\Practice 2 semester\\Finale\\final-project-starter\\TwitterMapperStarter\\data\\TwitterCapture.jobj");
    ...
    private void startThread() {
        ...
        Thread t = new Thread() {
            ...
            public void run() {
                ...
                long now;
                while (true) {
                  //  System.out.println("#1 I AM TRYING TO HANDLE TWEETS");
                    Object timeo = source.readObject();
                    if (timeo == null) break;
                    Object statuso = source.readObject();
                    if (statuso == null) break;
                 //   System.out.println("#2 Passed breaks!");
                   ...
                   // System.out.println("#3 I have successfully passed all the breaks and now am ready to handle tweets");
        ...
        System.out.println("Adding the new thread");
        t.start();
    }
